...
RUN --mount=type=cache,target=/app/.local/share/pnpm/store,uid=1001,gid=1001,sharing=locked \
...
RUN --mount=type=cache,target=/app/.local/share/pnpm/store,uid=1001,gid=1001 \
    --mount=type=cache,target=/app/node_modules,uid=1001,gid=1001 \
    --mount=type=cache,target=/app/packages/backend/node_modules,uid=1001,gid=1001 \
    pnpm run build
